...
config/aws-sso-refresh.json  optional private saved-account/browser selection for the common AWS SSO refresh command; LOCAL, gitignored, and not inherited; see `aws-sso-refresh`
