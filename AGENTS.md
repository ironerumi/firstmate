...
config/keepwarm-secs  optional home-local Claude keep-warm cadence; LOCAL, gitignored; see docs/configuration.md "Claude keep-warm cadence" for the configuration contract
