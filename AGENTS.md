...
The one exception is mechanical rather than a judgment call: at most one implementation task per repository in each home at a time, enforced at spawn by `bin/fm-impl-concurrency-guard.sh`, while scouts stay parallel.
