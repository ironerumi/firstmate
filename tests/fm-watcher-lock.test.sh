...
# wake, an attach, or a typed failure. The one-shot unexplained-cycle alert
# layered above that classification is owned by tests/fm-supervision-alert.test.sh.
