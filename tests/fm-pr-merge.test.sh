...
#   (ba) a landed merge clears only the hold that recorded ITS captain merge
#       wait, leaving any other captain hold in place
set -u
...
test_merge_clears_only_the_merge_wait_hold() {
  ...
  FM_TEST_HOME="$home" run_pr_merge "$case_dir" task-x1 https://github.com/example/repo/pull/41 \
