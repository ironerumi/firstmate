...
EOF
  ...
  # BSD/macOS sed's `a\` emits appended text without a trailing newline, which
  # glues the following backlog line onto it and corrupts the fixture. awk is
  # portable across both sed dialects.
