...
Claude's sibling `bin/fm-claude-keepwarm-selfwake.sh` provides supervisor keep-warm self-wakes independently of supervision need; [`turnend-guard.md`](turnend-guard.md#harness-integrations) owns its hook and cancellation contract.
