...
| `fm-claude-keepwarm-selfwake.sh` | Claude Stop `asyncRewake` hook for supervisor keep-warm self-wakes; see [turnend-guard.md](turnend-guard.md#harness-integrations) for its contract |
