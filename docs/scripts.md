...
| `fm-brief-repo-guard.sh` | Fork-added wrapper around `fm-brief.sh` that appends a control-plane boundary section when the brief targets Firstmate's own repo |
