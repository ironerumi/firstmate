...
FM_NM_KEEPWARM_RETRY_SECS=300      # first retry delay after an evaluation that delivered nothing (no active run, composer not confirmed-empty, refused send); doubles per consecutive miss and is capped at FM_NM_KEEPWARM_SECS
