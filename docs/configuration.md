...
FM_NM_KEEPWARM_SECS=1800           # maximum quiet interval before a Claude crew waiting out its own live no-mistakes run or parked at a gate receives one benign keep-warm activation; 0 disables it
