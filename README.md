...
- [docs/supervision-alerts.md](docs/supervision-alerts.md) - configure the alerts for a watcher that cannot be repaired and for work parked on a human decision.
