...
- [docs/supervision-alerts.md](docs/supervision-alerts.md) - configure the alerts for a watcher cycle that ended unexplained and for work parked on a human decision.
