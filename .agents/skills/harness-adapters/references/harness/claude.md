...
This differs from the per-task crewmate settings generated by `../../../bin/fm-spawn.sh`; `../../../docs/verification/runtime-backends.md` under "Claude commit attribution suppression" records the current commit-attribution evidence for that file.
