...
This is separate from the per-task crewmate settings generated by `bin/fm-spawn.sh`; [`docs/verification/runtime-backends.md`](../../../docs/verification/runtime-backends.md#claude-commit-attribution-suppression) records the current Claude commit-attribution evidence for that file.
