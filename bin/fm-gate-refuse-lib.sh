...
# top of each fleet-lifecycle entrypoint and called before any fleet
...
#
# Sourced by bin/fm-spawn.sh, bin/fm-task-register.sh, bin/fm-send.sh,
# bin/fm-teardown.sh, bin/fm-sessionstart-nudge.sh, and the tests.
