...
family_for_basename() {
  case "$1" in
    fm-arm-pretool-check.test.sh|fm-ask-user-authority.test.sh|fm-aws-sso-refresh.test.sh|fm-brief.test.sh|\
    ...
    fm-install-herdr.test.sh|fm-nm-guard.test.sh|fm-nm-test-contract.test.sh|\
    fm-merge-wait.test.sh|fm-no-mistakes-ownership.test.sh|\
