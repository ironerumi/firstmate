...
family_for_basename() {
  case "$1" in
    ...
    fm-brief.test.sh|fm-brief-repo-guard.test.sh|fm-vendor-auth-probe.test.sh|\
    ...
    fm-nm-guard.test.sh|fm-nm-keepwarm.test.sh|\
    ...
    fm-mail.test.sh|fm-mail-check.test.sh|fm-nm-config-keydiff.test.sh|\
    ...
    fm-spawn-dispatch-profile.test.sh|fm-claude-trust.test.sh|fm-spawn-claude-attribution.test.sh|\
    fm-trace-context-spawn.test.sh|fm-spawn-worktree-settle.test.sh|\
    fm-teardown-endpoint-safety.test.sh)
      printf '%s\n' backend-dispatch
      ;;
    fm-check-unregister.test.sh|fm-merge-local.test.sh|fm-pr-check-security.test.sh|fm-pr-merge.test.sh|\
    fm-review-diff.test.sh|fm-task-register.test.sh|fm-teardown.test.sh|fm-x-mode.test.sh)
      printf '%s\n' pr-forge
      ;;
    ...
    fm-claude-stop-autoarm.test.sh|fm-claude-keepwarm-selfwake.test.sh|fm-cursor-harness.test.sh|\
